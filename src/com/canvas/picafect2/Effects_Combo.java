...
public class Effects_Combo extends Activity implements OnClickListener {
	...
	Button bt, bt1, bt2, bt3, bt4, bt5, bt6, bt7, bt8, bt9, bt10, bt11, bt12, bt13,
			bt14, bt15, bt16, bt17, bt18, bt19, bt20, bt21, bt22, bt23, bt24,
			bt25, bt26, bt27, bt28, bt29, bt30;
	ImageView image;
	Bitmap bmp, bm;
	...
	public void onClick(View v) {
		...
		case R.id.effect_color_red:
			...
			bm = abmp8.getBitmap();
			image.setImageBitmap(ImageFilter.applyColorFilterEffect(bm, 255, 0, 0));
			break;
		case R.id.effect_color_green:
			BitmapDrawable abmp9 = (BitmapDrawable) image.getDrawable();
			bm = abmp9.getBitmap();
			image.setImageBitmap(ImageFilter.applyColorFilterEffect(bm, 0, 255, 0));
			break;
		case R.id.effect_color_blue:
			BitmapDrawable abmp10 = (BitmapDrawable) image.getDrawable();
			bm = abmp10.getBitmap();
			image.setImageBitmap(ImageFilter.applyColorFilterEffect(bm, 0, 0, 255));
			break;
		case R.id.effect_color_depth_64:
			BitmapDrawable abmp11 = (BitmapDrawable) image.getDrawable();
			bm = abmp11.getBitmap();
			image.setImageBitmap(ImageFilter.applyDecreaseColorDepthEffect(bm, 64));
			break;
		case R.id.effect_color_depth_32:
			BitmapDrawable abmp12 = (BitmapDrawable) image.getDrawable();
			bm = abmp12.getBitmap();
			image.setImageBitmap(ImageFilter.applyDecreaseColorDepthEffect(bm, 32));
			break;
		...
		case R.id.effect_gamma:
			...
			bm = abmp18.getBitmap();
			image.setImageBitmap(ImageFilter.applyGammaEffect(bm, 1.8, 1.8, 1.8));
			break;
		...
		case R.id.effect_sepia:
			...
			bm = abmp2.getBitmap();
			image.setImageBitmap(ImageFilter.applySepiaToningEffect(bm, 10, 1.5, 0.6, 0.12));
			break;
		case R.id.effect_sepia_blue:
			BitmapDrawable abmp23 = (BitmapDrawable) image.getDrawable();
			bm = abmp23.getBitmap();
			image.setImageBitmap(ImageFilter.applySepiaToningEffect(bm, 10, 0.88, 2.45,
					1.43));
			break;
		case R.id.effect_sepia_green:
			BitmapDrawable abmp24 = (BitmapDrawable) image.getDrawable();
			bm = abmp24.getBitmap();
			image.setImageBitmap(ImageFilter.applySepiaToningEffect(bm, 10, 1.2, 0.87, 2.1));
			break;
		...
		case R.id.effect_sheding_yellow:
			...
			bm = abmp27.getBitmap();
			image.setImageBitmap(ImageFilter.applyShadingFilter(bm, Color.YELLOW));
			break;
		case R.id.effect_sheding_green:
			BitmapDrawable abmp28 = (BitmapDrawable) image.getDrawable();
			bm = abmp28.getBitmap();
			image.setImageBitmap(ImageFilter.applyShadingFilter(bm, Color.GREEN));
			break;
